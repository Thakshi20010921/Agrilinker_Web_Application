  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <div className="mx-auto flex max-w-7xl flex-col gap-8 px-4 py-8 md:px-6 lg:flex-row lg:gap-10 lg:px-8 lg:py-10">
        <aside className="w-full rounded-3xl bg-white p-6 shadow-sm ring-1 ring-gray-100 lg:sticky lg:top-8 lg:w-64 lg:self-start">
          ...
          <div className="mt-8 rounded-2xl bg-gray-50 p-4 text-sm text-gray-500">
            ...
            <p className="mt-2">Select Overview to manage the full admin workspace.</p>
          </div>
        </aside>
